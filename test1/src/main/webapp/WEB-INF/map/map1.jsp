<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    ...
    <head>
        ...
        <script type="text/javascript"
            src="//dapi.kakao.com/v2/maps/sdk.js?appkey=f0dbfb3cf2440f7211569e65f8ce233f&libraries=services"></script>
        <style>
        table, tr, td, th{
    ...
    <body>
        <div id="app">
            ...
            <select style="margin-bottom : 20px; padding:5px" v-model="category" @change="fnSearch()">
            ...
            methods: {
                ...
                fnSearch() {
                    ...
                    for(let i = 0;i<self.markerList.length;i++){
                        self.markerList[i].setMap(null); //정해진 문법, 마커를 지도에서 제거해줌
                    }
                    self.markerList = []; // 보관의 역할을 끝냈기 때문에 새롭게 비워서 만들어줌
